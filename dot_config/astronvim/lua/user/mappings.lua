return {
  n = {
    ...
    ["<leader>rA"] = { function() require("crates").upgrade_all_crates() end, desc = "Upgrade All" },
    ["<leader>rH"] = { function() require("crates").open_homepage() end, desc = "Open HP" },
    ["<leader>rR"] = { function() require("crates").open_repository() end, desc = "Open Repo" },
    ["<leader>rD"] = { function() require("crates").open_documentation() end, desc = "Open Docs" },
    ["<leader>rC"] = { function() require("crates").open_crates_io() end, desc = "Open crates.io" },
  },
  v = {
    ["<leader>ru"] = { function() require("crates").update_crates() end, desc = "Update Crates" },
